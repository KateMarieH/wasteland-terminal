...
// Recreates old Netlify logic on the client
// -------------------------
...
async function loadNews() {
  try {
    const resp = await fetch(RSS_URL, {
      headers: {
        "User-Agent": "WastelandTerminal/1.0",
...
>$/, "").trim();
      ...
      const source = clean(sourceMatch ? sourceMatch[1] : "Google News");
